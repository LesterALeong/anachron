...
class V5ContractTests(unittest.TestCase):
    def test_scientific_governed_source_paths_are_literal_sorted_and_unique(self) -> None:
        ...
        self.assertEqual(V5_PROTOCOL_TAG, "v5-measurement-protocol-v6")
        self.assertEqual(len(V5_SCIENTIFIC_GOVERNED_SOURCE_PATHS), 49)
    ...
    def test_governed_closure_contains_every_a1_runtime_and_tool(self) -> None:
        ...
        required = {".gitattributes", "anachron/__init__.py", "anachron/v5_registry.py", "research/v5_measurement/v5_failure_binding.json", "tests/test_v5_identity_controller.py", "tests/test_v5_operational.py", "tools/.gitattributes", "tools/analyze_v5_measurement.py", "tools/build_v5_source_manifest.py", "tools/capture_read_only_v5_identity.py", "tools/finalize_v5_carry_forward.py", "tools/materialize_v5_inputs.py", "tools/read_v5_authenticode_identity.ps1", "tools/read_v5_process_identity.ps1", "tools/run_v5_conditional_campaign.ps1", "tools/run_v5_recovery.py"}
